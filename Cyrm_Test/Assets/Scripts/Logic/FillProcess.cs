...
namespace Logic
{
    public class FillProcess : MonoBehaviour
    {
        ...
        public void StartOrResumeFill(float fillTime)
        {
            ...
            {
                _fillCoroutine = StartCoroutine(FillImageOverTime(_elapsedTime, _startFillAmount, _targetFillAmount, fillTime));
            }
            else
            {
                ResetFill();
                _fillCoroutine = StartCoroutine(FillImageOverTime(0f, 0f, 1f, fillTime));
            }
        }
